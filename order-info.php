...
<body class="row justify-content-center">
    ...
    <div class="content justify-content-center row col-md-12">
        ...
        <div class="items col-md-10 justify-content-center row">
            <button type="button" class="btn btn-primary btn-lg col-md-4 p-3" onclick="window.location.href='./order-contract.php?order=<?php echo $_GET['order']?>'">Order contract <span class="fa fa-file-signature"></span></button>
            <button type="button" class="btn btn-primary btn-lg col-md-4 p-3" onclick="window.location.href='./order-payment.php?order=<?php echo $_GET['order']?>'">Order payment <span class="fa fa-money-bill-wave-alt"></span></button>
        </div>
    </div>
</body>
