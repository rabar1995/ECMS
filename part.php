...
<head>
    ...
    if($part_number == 1){
        ...
        header("Location:parts.php?part=1");
    }
    ?>
</head>
...
<body class="row justify-content-center">
    ...
    <div class="content justify-content-center row col-md-12">
        ...
        <div class="items col-md-10 justify-content-center row">
            <button type="button" class="btn btn-primary btn-lg col-md-4 p-3" onclick="window.location.href='./projects.php?part=<?php echo $part_number;?>'">Projects <span class="fa fa-project-diagram"></span></button>
            <button type="button" class="btn btn-primary btn-lg col-md-4 p-3" onclick="window.location.href='./offers.php?part=<?php echo $part_number;?>'">Offers <span class="fa fa-sticky-note"></span></button>
            <button type="button" class="btn btn-primary btn-lg col-md-4 p-3" onclick="window.location.href='./employ_salary.php?part=<?php echo $part_number;?>'">Employee Salary <span class="fa fa-users"></span></button>
        </div>
    </div>
</body>
