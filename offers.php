...
<head>
    ...
    if($part_number == 1){
        ...
        header("Location:projects.php?id=1");
    }
    
    if(!empty($_POST['iname'])){
       $db -> query("INSERT INTO offers (pid, project_name, date) values(".$_GET["part"].",'".$_POST['iname']."','".date('Y-m-d')."')");
        $success="true";
    }
    
            $avg_amount = $db -> query("select count(id) from offers where pid = ".$part_number);
    ...
    $db -> query("DELETE FROM `offers` WHERE id=".$_GET["delete"]);
    $success == "true"?:$success="delete";
    }
    try{
        if(!empty($_POST["search"])){
            $result = $db -> query("select * from offers where pid=".$_GET["part"]." and project_name LIKE '%".$_POST["search"]."%' order by id desc");
            $res = $result->fetchAll();
        }else{
            $result = $db -> query("select * from offers where pid=".$_GET["part"]." order by id desc limit {$page},{$results}");
            $res = $result->fetchAll();
        }
    }catch(Exception $e){
...
<body class="row justify-content-center">
    ...
    <div class="content justify-content-center row col-md-12">
        ...
        <div class="row col-md-6 justify-content-end">
            <a class="plus-button" href="#" data-toggle="modal" data-target="#exampleModal">Add offer<span class="fa fa-lg fa-plus ml-1"></span></a>
            <!-- Modal -->
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Adding offer</h5>
                        ...
                        <div class="modal-body">
                            <form method="post">
                                <div class="form-group">
                                    ...
                                    <small id="emailHelp" class="form-text text-muted">Adding offer to <?php echo $part?></small>
                                </div>
            ...
            <div class="table-list table-striped table-responsive-sm col-md-12">
                <table class="table table-hover">
                    <thead class="thead-dark">
                        <tr>
                            <th scope="col" id="c1">Offer name</th>
                            <th scope="col" id="c2">Offer type</th>
                    ...
                    <tbody>
                        ...
                        <tr scope="row">
                            ...
                            <td id="c5"><a href="offer-edit.php?part=<?php echo $_GET["part"]; ?>&offer=<?php echo $res[$i][0] ?>"><span class="fa fa-edit"></span></a></td>
                            <td id="c6">
                        ...
                        <script type="text/javascript">
                            function deleteRow(rowId) {
                                if (confirm("Are you sure you want to delete this data?")) {
                                    window.location.href = "offers.php?part=<?php echo $_GET["part"]; ?>&delete=" + rowId
                                }
                            }
            ...
            <div class="row justify-content-center">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li><a class="text-dark page-link <?php if(($i-1)==($page/$results)){echo "bg-warning";}?>" <?php echo 'href="offers.php?part='.$_GET["part"].'&page='.($i-1).'"';?>>
                                <?php echo $i;?></a></li>
                        <?php }?>
                    </ul>
                </nav>
    ...
    <div class="toast mr-5 mb-5 p-3" style="position:fixed;bottom:0; right:0;z-index:2;" data-delay="9000" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body text-wight-bold">
            <?php
            if($success == "true"){
                echo "Offer has successfuly been added";
            }else if($success == "delete"){
                echo "offer has successfuly been deleted";
            }
            ?>
