            ...
            <tr>
                <td>
                    ...
                    <div style="width:90%; margin:auto;">
                        <div style="text-align:right;"><b>ئۆفەر:</b>
                            <hr>
                        </div>
                        <div class="info" style="text-align:right;">
                            <b>بۆ بەڕێز</b> : <?= $res[0][2] ?>
                        ...
                        <table style="text-align: right;width: 90%;">
                            <thead style="border-bottom: 1px solid gray;">
                                <tr>
                                    <td><b>تایبەتمەندیەکان</b></td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td><?= nl2br($band_res[0][3]); ?></td>
                                </tr>
                            </tbody>
                        </table>
                        <table style="text-align: right; width: 90%;">
                        ...
                        <table style="text-align: right;width: 90%;">
                            ...
                            <tbody>
                                <tr>
                                    <td><?= nl2br($band_res[0][5]); ?></td>
                                </tr>
                            </tbody>
                        </table>
                        <table class="mb-2" style="text-align: right;width: 90%;">
                            <thead style="border-bottom: 1px solid gray;">
                                <tr>
                                    <td><b>نرخەکان</b></td>
                                </tr>
                        ...
                        <table class="faqara col-md-10 p-5">
                            <thead>
                                <tr style="background-color: #f99d1d; ">
                                    ...
                                    <th scope="col" class="p-2">جۆری کاڵا</th>
                            ...
                            <tbody>
                                ...
                                if($i%2==0){?>
                                <tr style="background: rgba(255, 212, 128, 0.6);">
                                    <?php } else if($i%2==1){ ?>
                                <tr style="background:rgba(255, 238, 204, 0.6);">
                                    <?php }?>
